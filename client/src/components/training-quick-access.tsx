...
export function TrainingQuickAccess() {
  ...
  return (
    <>
      ...
      <motion.button
        className="fixed bottom-20 right-4 z-40 w-14 h-14 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full shadow-lg flex items-center justify-center"
        whileTap={{ scale: 0.9 }}
